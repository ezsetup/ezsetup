<template>
  <div class="main" v-if="!isLoading">
    ...
    <template v-for="(question, i) in questions">
      ...
      <div class="columns is-1">
        ...
        <div class="column is-1">
          <input class="input" type="text" size="3" v-model="scores[i]" value="">
        </div>
        <div class="column is=1">
          / {{ assessment.scores[i] }}
        </div>
      ...
      <div class="columns is-1">
        ...
        <div class="column is-half"><textarea class="textarea" v-model="feedback[i]"></textarea></div>
      </div>
    </template>
    ...
    <input class="button is-primary" type="submit" @click="submitGrade()">
  </div>
</template>
