...
<template>
  <svg>
    ...
    <line :filter="filter" @mouseover="onMouseOver" @mouseout="onMouseOut" @click="onClick" :x1="el.network.x" :y1="el.network.y" :x2="el.target.x" :y2="el.target.y" stroke-width="5" stroke="black" />
  </svg>
</template>
